...
w = World.make(grid_rows=ROWS, horizon=80)
alice = CookAgent(w.grid, me=0, parallel_after_delay=0)
partner = CookAgent(w.grid, me=1, parallel_after_delay=None)
logs, m = run_episode(w, [alice, partner], horizon=80)
print(m)
for l in logs[:40]:
    print(f"t={l['t']:3d} pots={l['pot']} i0={l['intent0']}@{str(l['target0']):>5} i1={l['intent1']}@{str(l['target1']):>5} p0={l['p0']} p1={l['p1']} h0={l['held0']} h1={l['held1']} a={l['a']}")
