...
7. **文档/复现**：主结论别引用组 A；`experiment_design_v2.md`/`motivation_evidence.md` 里的旧口径需要按"只用 LLM 组"重写一遍。
...
有任何不确定，先读 `experiment_design_v2.md`（设计）与 `plan_motivation_validation.md`（整体验证计划）。
